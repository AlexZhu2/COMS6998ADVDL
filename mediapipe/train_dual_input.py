...
# ---------------------------- Data ----------------------------
train_dataset = DualInputPoseDataset("processed_data/workoutfitness-train/train_list.txt")
val_dataset = DualInputPoseDataset("processed_data/workoutfitness-val/val_list.txt")
train_loader = DataLoader(train_dataset, batch_size=BATCH_SIZE, shuffle=True)
val_loader = DataLoader(val_dataset, batch_size=BATCH_SIZE, shuffle=False)

# ---------------------------- Model ----------------------------
model = DualInputR2Plus1D(num_classes=NUM_CLASSES).to(device)
