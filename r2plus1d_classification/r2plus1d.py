...
train_dataset = FitnessData(root_dir=os.path.join(os.getcwd(), "kaggle_data/workoutfitness-video"), train=True, transform=None, frames_per_clip=16)
val_dataset = FitnessData(root_dir=os.path.join(os.getcwd(), "kaggle_data/workoutfitness-video"), train=False, transform=None, frames_per_clip=16)
